...
def main():
    ...
    # 1. We create the train_dataset *first* and store it in a variable.
    #    (The 'transforms.RandomSizedCrop(224)' is left as-is from your original script)
    # This is the NEW, correct code
    train_dataset = datasets.ImageFolder(traindir, transforms.Compose([
            transforms.RandomResizedCrop(224), # <--- THIS IS THE FIX
    ...
    train_loader = torch.utils.data.DataLoader(
        train_dataset, # This line is CHANGED
        batch_size=args.train_batch, shuffle=True,
        num_workers=args.workers, pin_memory=True)

    # --- END OF CHANGE ---

    # This is the NEW, correct validation code
    val_loader = torch.utils.data.DataLoader(
    datasets.ImageFolder(valdir, transforms.Compose([
        transforms.Resize(256), # <--- THIS IS THE FIX
    ...
    # Adapt the model's final layer to num_classes
    if args.pretrained:
